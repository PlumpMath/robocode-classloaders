...
public class RobotClassLoader extends URLClassLoader implements IRobotClassLoader {
	...
	protected Set<String> referencedClasses = new HashSet<String>();
	...
	public synchronized Class<?> loadClass(final String name, boolean resolve)
		...
		if (isLanguageLibraryClass(name)) {
	...
	protected void testPackages(String name) throws ClassNotFoundException {
	...
	private ByteBuffer findLocalResource(final String name) {
		return AccessController.doPrivileged(new LocalResourceFinder(this, name));
	}
	...
	protected void warnIfStaticRobotInstanceFields() {
