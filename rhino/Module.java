...
public class Module {
    static {
        ...
        Container.cache.addComponent("robocode.host.rhino.advanced", RhinoHost.class);
        Container.cache.addComponent("robocode.host.rhino.team", RhinoHost.class);
        Container.cache.addComponent("robocode.host.rhino.ratecontrol", RhinoHost.class); //default
        Container.cache.addComponent("robocode.host.rhino.droid", RhinoHost.class);
        Container.cache.addComponent("robocode.host.rhino.bordersentry", RhinoHost.class);
    }
}
